...
INSERT INTO medical_file (insurance_number, patient_id)
...
VALUES ('Diabetes', 'Insulin therapy', '2022-01-01', '2022-12-31', (SELECT id FROM doctor WHERE last_name = 'Doe' AND first_name = 'Jane'), (SELECT id FROM medical_file WHERE insurance_number = 'AHIN12345678'));
...
VALUES ('NYU Langone Health', '2022-01-01', 'Diabetes', 'Insulin therapy', 'Annual checkup', (SELECT id FROM doctor WHERE last_name = 'Doe' AND first_name = 'Jane'), (SELECT id FROM medical_file WHERE insurance_number = 'AHIN12345678'));
